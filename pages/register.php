          ...
          <div class="card shadow-2-strong" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center">
              <form action="" method="post">
                ...
                <div class="form-outline mb-3">
                  <input type="password" name="konfirmasi-password" id="konfirmasi-password" class="form-control form-control-md" required
                    placeholder="Konfirmasi Password" />
                </div>
                <!-- <button class="btn btn-primary btn-lg w-100" type="submit">Daftar</button> -->
                <a class="btn btn-primary btn-lg w-100" href="login.php">Daftar</a>
              </form>
              <hr class="my-4">
