...
if (isset($_POST['submit'])) {
  ...
  // Check email
  $cekEmail = "SELECT * FROM users WHERE email = '$email' AND email != '$dataUser[email]'";
          ...
          <div class="card bg-body-secondary p-4">
            <div class="row container-fluid">
              <div class="card-head col-4 text-center p-3">
                <img id="preview" src="../images/users/<?= $dataUser['gambar'] ?>" width="200" height="200" class="bg-white rounded-circle  object-fit-contain" alt="">
              </div>
              <div class="card-body col-8">
                <form class="form" action="" method="post" enctype="multipart/form-data">
                  <div class="mb-2">
                    <label for="username" class="form-label">Username</label>
                    <input type="text" class="form-control" id="username" placeholder="Username" name="username" value="<?php echo $dataUser['username']; ?>">
                  </div>
                  <div class="mb-2">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" class="form-control" id="email" placeholder="Email" name="email" value="<?php echo $dataUser['email']; ?>">
                  </div>
                  <div class="mb-2">
                  ...
                  <?php if ($dataUser['id'] == $_SESSION['id']) { ?>
                    <div class="mb-2">
                      <div class="row px-3">
                        <div class="col-6">
